...
RecyclerView.Adapter<FilterViewAdapter.ViewHolder>()
{
    ...
    inner class ViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
        ...
        val mTxtFilterName : TextView = itemView.findViewById(R.id.tvFilterName)
    ...
    private fun setupFilters(){
        ...
        mPairList.add(Pair("filters/temperature.png", PhotoFilter.TEMPERATURE))
        ...
        mPairList.add(Pair("filters/flip_horizontal.png", PhotoFilter.FLIP_HORIZONTAL))
